    ...
    if (this.props.redirect) {
      ...
      return (
        <div className="create-employee">
          ...
          {this.state.avatar===""?(<img className="avatar-large" src={require("../../avatar/Default-avatar.png")} alt="avatar"/>):(<img className="avatar-large" src={this.state.avatar} alt="avatar"/>)}
